...
// function Navbar() {
//   return (
//     <div className='bg-blue-900 text-white text-sm flex place-content-between px-8 py-2'>
//         <div>
//             <select className='bg-blue-900 outline-none' name="currency" id="">
//                 <option selected value="CAD">CAD</option>
//                 <option value="USD">USD</option>
//                 <option value="PKR">PKR</option>
//             </select>
//         </div>
//         <p className='font-medium'>Get free delivery on orders over $100</p>
//         <div className="flex">
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                {/* Search */}
                {/* <div className="flex  w-2/6 sm:w-4/6 lg:w-full ml-4 sm:ml-0 border-gray-200 border-solid border-[1px] rounded-lg items-center">
                  <a href="#" className="p-2 text-gray-400 hover:text-gray-500">
                    <span className="sr-only">Search</span>
                    <MagnifyingGlassIcon className="h-6 w-6" aria-hidden="true" />
                  </a>
                  <div className='hidden sm:block flex align-start items-center w-full '>
                    <input type="text" className='text-gray-400 w-full placeholder:px-1 py-2 outline-none rounded-lg' placeholder='Search' />
                  </div>
                </div> */}
